...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-4 z-50 w-full px-4 md:px-6 py-4">
      <div className="glass dark:glass-dark rounded-2xl border border-white/20 dark:border-primary-900/30 shadow-glass dark:shadow-glass-dark">
